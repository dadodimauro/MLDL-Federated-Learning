...
class LocalUpdate(object):
    def __init__(self, dataset, idxs, mu=0.01, gpu=1, optimizer="sgd", local_batch_size=10,
                 lr=0.01, local_epochs=10, loss_function="CrossEntropyLoss"):
        ...
        self.proximal_criterion = nn.MSELoss(reduction='mean')
    ...
    def update_weights(self, model, global_round):
        ...
        for epoch in range(1, self.local_epochs + 1):
            ...
            for batch_idx, (images, labels) in enumerate(self.trainloader):
                ...
                loss = self.criterion(output, labels) + (self.mu / 2) * proximal_term
